    ...
    <div className="dark:bg-[#172b44] dark:text-white p-6 rounded-lg w-full max-w-7xl mx-auto px-4 sm:px-6">
      ...
      {showModal && (
        <SuperModal onClose={() => setShowModal(false)}>
          <div className=" flex md:max-h-[85vh] lg:max-h-[88vh] xl:max-h-[88vh] overflow-hidden overflow-y-auto  scrollbar-thin ">
            <div className="p-2 rounded  max-w-md mx-auto items-center justify-center">
              ...
              <div className="grid grid-cols-2 text-sm border border-gray-600 mb-4">
                ...
                <div className="border border-gray-600 p-2">
                  <input
                    ...
                    className="w-full px-2 py-1 rounded border border-gray-500 outline-none"
                  />
                </div>
              ...
              <form className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 rounded border border-gray-600 outline-none"
                  />
                </div>
