    ...
    <div className="h-[90vh] 2xl:max-w-[80%] p-4 mx-8 dark:bg-darkBlue/70 rounded 2xl:mx-auto text-gray-800 overflow-hidden overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 bg-transparent mt-2">
      <div className="h-fit dark:text-white p-4 px-4 pb-6 dark:bg-darkBlue/70 rounded text-gray-800 bg-white">
        ...
        <form
          ...
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 items-end"
        >
          <div>
          ...
          <div className="relative">
            ...
            <a
              href="/profile/view"
              className="absolute left-2 sm:left-0 -bottom-4 sm:-bottom-5 lg:mt-9 text-secondary text-[10px] lg:text-xs"
            >
              Generate/Forgot Pin?
            </a>
          </div>

          <div className="col-span-1 sm:col-span-2 md:col-span-2 flex gap-4 justify-center mt-2">
            <button
              type="submit"
