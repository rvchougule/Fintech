...
const Payout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-transparent py-10 px-4">
      ...
      <div className="max-w-6xl mx-auto mt-10 bg-white dark:bg-transparent border dark:border-white border-walletLabelGray shadow-md rounded-xl p-6">
