...
const Clubsandassociations = () => {
  ...
  return (
    <div className="h-[90vh] 2xl:max-w-[80%] p-4  dark:text-white dark:transparent  2xl:mx-auto text-gray-800 overflow-hidden overflow-y-auto px-4 pb-6 scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-gray-100">
      {
        <PaymentForm
          title="Bill Payment"
