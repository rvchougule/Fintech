...
const DthRechargeModal = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-50  bg-opacity-50 flex items-center justify-center overflow-y-auto">
      <div className="bg-white w-[90%] md:w-[60%] lg:w-[50%] max-h-[80vh] rounded-lg shadow-lg p-6 overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
        {/* Header */}
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-semibold text-gray-800">Dth Plans</h2>
          <button
            onClick={onClose}
...
export default DthRechargeModal;
